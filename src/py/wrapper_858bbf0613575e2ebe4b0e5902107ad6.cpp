...
void wrapper_858bbf0613575e2ebe4b0e5902107ad6()
{
    ...
    void  (::std::set< double, ::std::less< double >, ::std::allocator< double > >::*method_pointer_3f2f8976fb6b59a99d5059c6176d54f9)(class ::std::set< double, struct ::std::less< double >, class ::std::allocator< double > > &) = &::std::set< double, struct ::std::less< double >, class ::std::allocator< double > >::swap;
