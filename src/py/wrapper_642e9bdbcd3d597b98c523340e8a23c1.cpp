...
void wrapper_642e9bdbcd3d597b98c523340e8a23c1()
{
    ...
    class ::statiskit::stl::Generator< class ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > > >  (*function_pointer_642e9bdbcd3d597b98c523340e8a23c1)(class ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > > const &) = ::statiskit::stl::generator;
    boost::python::def("__iter__", function_pointer_642e9bdbcd3d597b98c523340e8a23c1, "");
}