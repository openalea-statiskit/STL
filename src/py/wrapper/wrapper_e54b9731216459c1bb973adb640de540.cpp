...
void wrapper_e54b9731216459c1bb973adb640de540()
{
    ...
    bool  (*function_pointer_e54b9731216459c1bb973adb640de540)(int &, ::statiskit::Index const &) = ::statiskit::stl::insert;
    boost::python::def("insert", function_pointer_e54b9731216459c1bb973adb640de540, "");
}