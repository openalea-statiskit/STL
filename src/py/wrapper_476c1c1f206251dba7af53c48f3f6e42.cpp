...
void wrapper_476c1c1f206251dba7af53c48f3f6e42()
{
    ...
    ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::key_compare  (::std::set< unsigned long int, ::std::less< unsigned long int >, ::std::allocator< unsigned long int > >::*method_pointer_7b7f418f2fc858ea8d6754a7716d7d66)() const = &::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::key_comp;
    ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::value_compare  (::std::set< unsigned long int, ::std::less< unsigned long int >, ::std::allocator< unsigned long int > >::*method_pointer_f6b78bb3072e5794bb74926adc04ef6e)() const = &::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::value_comp;
    ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::allocator_type  (::std::set< unsigned long int, ::std::less< unsigned long int >, ::std::allocator< unsigned long int > >::*method_pointer_d6db1e53090157a38e4505d1005b85d5)() const = &::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::get_allocator;
    ...
    void  (::std::set< unsigned long int, ::std::less< unsigned long int >, ::std::allocator< unsigned long int > >::*method_pointer_961d06b96bc65f909b9fcfebb5be338b)(class ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > > &) = &::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::swap;
    ...
    class_476c1c1f206251dba7af53c48f3f6e42.def(boost::python::init< ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::allocator_type const & >(""));
    class_476c1c1f206251dba7af53c48f3f6e42.def(boost::python::init< class ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > > const &, ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > >::allocator_type const & >(""));
    class_476c1c1f206251dba7af53c48f3f6e42.def("key_comp", method_pointer_7b7f418f2fc858ea8d6754a7716d7d66, "");
