...
void wrapper_dc5522842bc75d8b9ac7b46020c60854()
{
    ...
    void  (::std::vector< unsigned long int, ::std::allocator< unsigned long int > >::*method_pointer_255286113a5c5557941485961dbbed98)(::std::vector< unsigned long int, class ::std::allocator< unsigned long int > >::size_type ) = &::std::vector< unsigned long int, class ::std::allocator< unsigned long int > >::resize;
    void  (::std::vector< unsigned long int, ::std::allocator< unsigned long int > >::*method_pointer_92217960d2e55ef0820eba05a2c16db3)(::std::vector< unsigned long int, class ::std::allocator< unsigned long int > >::size_type , ::std::vector< unsigned long int, class ::std::allocator< unsigned long int > >::value_type const &) = &::std::vector< unsigned long int, class ::std::allocator< unsigned long int > >::resize;
    ...
    class_dc5522842bc75d8b9ac7b46020c60854.def("resize", method_pointer_255286113a5c5557941485961dbbed98, "");
    class_dc5522842bc75d8b9ac7b46020c60854.def("resize", method_pointer_92217960d2e55ef0820eba05a2c16db3, "");
